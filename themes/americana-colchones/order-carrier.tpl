                ...
                {else}
                    ...
                    {if $opc}
                        ...
                        <div>
                            ...
                            <textarea class="form-control" cols="120" rows="8" name="message" id="message">{strip}
                        ...
                        {/if}
                            ...
                            {if $giftAllowed}
                                ...
                                <p id="gift_div">
                                    ...
                                    <textarea rows="8" cols="120" id="gift_message" class="form-control" name="gift_message">{$cart->gift_message|escape:'html':'UTF-8'}</textarea>
                                </p>
                            {/if}
                            {/if}
                                {/if}
