...
<div itemscope itemtype="https://schema.org/Product">
    ...
    <div class="primary_block row">
        ...
        {/if}
        <!-- left infos-->
        <div class="column-product pb-left-column col-xs-12 col-sm-6 col-md-6">
            <!-- product img-->
            <div id="image-block" class="clearfix" style="background-image: url('{$link->getImageLink($product->link_rewrite, $cover.id_image, 'large_default')|escape:'html':'UTF-8'}');">
                {if $product->on_sale}
            ...
            {if isset($images) && count($images) > 1}
                <p style="display: none;" class="resetimg clear no-print">
        ...
        <!-- end left infos-->
        <!-- center infos -->
        <div class="column-product pb-center-column col-xs-12 col-sm-6 col-md-6">
            {if $product->online_only}
                <p class="online_only">{l s='Online only'}</p>
            {/if}
            <h1 style="padding-bottom: 0px;" itemprop="name">{$product->name|escape:'html':'UTF-8'} - 
		<small id="product_ean13"{if empty($product->ean13) || !$product->ean13} style="display: none;"{/if}>
                    <label>{l s='Reference:'}: </label>
                    <span class="editable" itemprop="ean13"{if !empty($product->ean13) && $product->ean13} content="{$product->ean13}"{/if}>{if !isset($groups) || true}{$product->ean13|escape:'html':'UTF-8'}{/if}</span>
                </small>
	    </h1>
            {* hook h='gkrating' product_id=$product->id *}
        ...
        <p id="pQuantityAvailable" style="display: none;" {if $product->quantity <= 0} style="display: none;"{/if}>
        ...
        {*
        <p style="display: none;" id="availability_statut"{if !$PS_STOCK_MANAGEMENT || ($product->quantity <= 0 && !$product->available_later && $allow_oosp) || ($product->quantity > 0 && !$product->available_now) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
    ...
    {/if}
    <p style="display: none;" id="availability_date"{if ($product->quantity > 0) || !$product->available_for_order || $PS_CATALOG_MODE || !isset($product->available_date) || $product->available_date < $smarty.now|date_format:'%Y-%m-%d'} style="display: none;"{/if}>
    ...
    <!-- Out of stock hook -->
    <div style="display: none;" id="oosHook"{if $product->quantity > 0} style="display: none;"{/if}>
        {$HOOK_PRODUCT_OOS}
    </div>
    <div class="clearfix"></div>
	    ...
	    <!-- Data sheet -->
	    <div class="col-md-9" style="padding: 0px;">
	    <h3 class="page-product-heading" style="padding-left: 0px; font-size: 16px; padding-bottom: 0px; margin-bottom: 5px;">{l s='Características'}</h3>
        ...
        {if ($product->show_price && !isset($restricted_country_mode)) || isset($groups) || $product->reference || (isset($HOOK_PRODUCT_ACTIONS) && $HOOK_PRODUCT_ACTIONS)}
            ...
            <form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
                ...
                <div class="box-info-product">
                    <div style="padding-left: 0px; padding-right: 0px;" class="content_prices clearfix">
                                    ...
                                    {foreach from=$groups key=id_attribute_group item=group}
                                        {if $group.attributes|@count}
                                            <fieldset class="attribute_fieldset">
                                                <label style="font-size: 15.3px; text-transform: uppercase;" class="attribute_label" {if $group.group_type != 'color' && $group.group_type != 'radio'}for="group_{$id_attribute_group|intval}"{/if}>{$group.name|escape:'html':'UTF-8'}&nbsp;</label>
                    ...
                    {if !$PS_CATALOG_MODE}
                        <div class="col-md-4" style="padding: 0px;">
                            <p id="quantity_wanted_p"{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
                                <label for="quantity_wanted" style="font-size: 15.2px;">{l s='CANTIDAD'}</label>
                        ...
                        <p class="our_price_display" itemprop="offers" itemscope itemtype="https://schema.org/Offer">{strip}
                            ...
                            {if $priceDisplay >= 0 && $priceDisplay <= 2}
                                ...
                                {if $tax_enabled  && ((isset($display_tax_label) && $display_tax_label == 1) || !isset($display_tax_label))}
                                    {if $priceDisplay == 1} {l s=''}{else} {l s=''}{/if}
                                {/if}
                                                    ...
                                                    <div{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="unvisible"{/if}>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                                                <button type="submit" name="Submit" class="exclusive form-control"><span style="padding-left: 50px; line-height: 25px;">COMPRAR</span></button>
                                                            ...
                                                            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                                <a href="/content/44-americana-credito"><img src="/img/cms/product-americana-credito.png" /></a>
                                                            </div>
                                                        </div>
                                                        <br>
                                                        <div class="col-md-12">
                                                            <span style="display: inline-block;">COMPARTIR EN: </span>{if isset($HOOK_EXTRA_RIGHT) && $HOOK_EXTRA_RIGHT}{$HOOK_EXTRA_RIGHT}{/if}
                                                        </div>
                                                    </div>
                                ...
                                <div class="container">
                                    ...
                                    {if !$content_only}
                                        ...
                                        {if isset($product) && $product->description}
                                            <!-- More info -->
                                            <section class="page-product-box">
                                                <h3 class="page-product-heading">{l s='More info'} INFORMACIÓN</h3>
                                                <!-- full description -->
