		...
		{if $comments}
			...
			<p class="align_center">
				<a id="new_comment_tab_btn" class="btn btn-default button button-small open-comment-form" href="#new_comment_form">
					<span>{l s='Escribe tus comentarios acerca del producto!' mod='productcomments'}</span>
				</a>
			</p>
			{/if}
		{else}
			...
			<p class="align_center">
				<a id="new_comment_tab_btn" class="btn btn-default button button-small open-comment-form" href="#new_comment_form">
					<span>{l s='Se el primero en comentar sobre este producto!' mod='productcomments'}</span>
				</a>
			</p>
			{else}
			<p class="align_center">{l s='Ningún cliente ha comentado acerca de este producto.' mod='productcomments'}</p>
			{/if}
		{/if}
