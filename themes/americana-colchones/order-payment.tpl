...
<script type="text/javascript">
   /* <![CDATA[ */
{literal}
   var google_conversion_id = 975076822;
   var google_conversion_language = "en";
   var google_conversion_format = "3";  
   var google_conversion_color = "ffffff";  
   var google_conversion_label = "MfMCKvAg28Q1vv50AM";  
   var google_conversion_value = false;
{/literal}
   /* ]]> */
   </script>
  ...
  src="//www.googleadservices.com/pagead/conversion/975076822/?label=MfKMCKvAg28Q1vv50AM&amp;guid=ON&amp;script=0"/>
   </div>
   </noscript>
{if !$opc}
