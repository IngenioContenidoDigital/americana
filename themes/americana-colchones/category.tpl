...
{if isset($category)}
            ...
            <div class="col-md-8 text-right">
                <div class="sortPagiBar clearfix">
                    <div class="row" style="padding: 15px; padding-right: 0px;">
                        <div class="col-md-2 col-md-offset-5" style="padding-top: 5px;">
                            ORDENAR POR:
                        </div>
                        <div class="col-md-5">
    ...
    {if isset($subcategories)}
        {if (isset($display_subcategories) && $display_subcategories eq 1) || !isset($display_subcategories) }
            <!-- Subcategories -->
            <div id="subcategories" class="center_column col-xs-12 col-sm-12">
                ...
                <ul class="clearfix">
                    ...
                    {/foreach}
                    <li>
                        <h5><a class="subcategory-name azul" href="#">TODOS</a></h5>
                    </li>
                </ul>
            </div>
        {/if}
    ...
    {if $products}
        ...
        {include file="./product-list-custom-cat.tpl" products=$products}
