		...
		<fieldset>
			<div class="box">
				...
				<div id="opc_account_form" class="unvisible">
					...
					<div class="required form-group">
			                    <label for="cedula">{l s='Número de cédula'} <sup>*</sup></label>
			                    <input type="text" class="is_required validate form-control" data-validate="isNumber" id="cedula" name="cedula" value="{if isset($guestInformations) && isset($guestInformations.customer_cedula) && $guestInformations.customer_cedula}{$guestInformations.customer_cedula}{/if}" />
                			</div>
                    ...
                    <!-- Do you want to validate it? data-validate="isCityName"  -->
					<div class="required text form-group inputcity">
						<label for="city">{l s='City'} <sup>*</sup></label>
						<input type="text" class="text form-control validate" name="city" id="city" value="{if isset($guestInformations) && isset($guestInformations.city) && $guestInformations.city}{$guestInformations.city}{/if}" />
					</div>
					{/if}
					{/foreach}
					{if !$postCodeExist}
