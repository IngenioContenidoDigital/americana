...
<div class="container">
    <div class="breadcrumb clearfix">
        <a class="home" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}" title="{l s='Return to Home'}"><i class="fa fa-home"></i><span style="font-size: 13px;font-family: 'Open Sans' !important;font-weight: normal; margin-left: 10px; margin-right: -5px;">/</span></a>
