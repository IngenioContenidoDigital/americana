			...
			<div class="clearfix">
				<div class="col-xs-12 col-md-3">
					...
					{/if}
                                        ...
                                        <p class="form-group">
						<label for="nombre">{l s='Nombre y Apellido'}</label>
						{if !empty($cookie->customer_firstname) && !empty($cookie->customer_lastname)}
							<input class="form-control grey" type="text" id="nombre" name="nombre" value="{$cookie->customer_firstname} {$cookie->customer_lastname}" readonly="readonly" />
						{else}
					...
					<p class="form-group">
						<label for="celular">{l s='Celular'}</label>
					        <input class="form-control grey" type="text" id="celular" name="celular" value="" />
					</p>
					{if !$PS_CATALOG_MODE}
					...
					{/if}
					{if $fileupload == 1}
						<p class="form-group contenedor_upload_file">
