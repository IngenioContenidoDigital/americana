...
class StoresController extends StoresControllerCore
{
    ...
    public function setMedia()
    {
        ...
        if (!Configuration::get('PS_STORES_SIMPLIFIED')) {
            ...
            $this->addJS('http'.((Configuration::get('PS_SSL_ENABLED') && Configuration::get('PS_SSL_ENABLED_EVERYWHERE')) ? 's' : '').'://maps.googleapis.com/maps/api/js?key=AIzaSyBB-pyvLJjIcFKHcYeuEndGTmV7QcEVPck&region='.substr($default_country->iso_code, 0, 2));
