...
class PayuLatam extends PaymentModuleCore {
	...
	$this->context->smarty->assign(array(
		'tab' => array(
			...
			'credential' => array(
				...
				'icon' => '/modules/payulatam/img/credentials.png',
				'tab' => 'credenciales',
	...
	$this->context->smarty->assign(array(
		...
		'credentialInputVar' => array(
			...
			'account_id' => array(
				'name' => 'account_id',
				'required' => false,
				'value' => (Tools::getValue('account_id') ? Tools::safeOutput(Tools::getValue('account_id')) : Tools::safeOutput(Configuration::get('PAYU_LATAM_ACCOUNT_ID'))),
				'type' => 'text',
				...
				'name' => 'api_login',
				'required' => false,
				'value' => (Tools::getValue('api_login') ? Tools::safeOutput(Tools::getValue('api_login')) : Tools::safeOutput(Configuration::get('PAYU_LATAM_API_LOGIN'))),
				'type' => 'text',
				...
				'name' => 'public_key',
				'required' => false,
				'value' => (Tools::getValue('public_key') ? Tools::safeOutput(Tools::getValue('public_key')) : Tools::safeOutput(Configuration::get('PAYU_LATAM_PUBLIC_KEY'))),
				'type' => 'text',
...
if(isset($this->context->cookie->{'error_pay'}) && !empty($this->context->cookie->{'error_pay'}) ) {
    ...
    $arrayBank=$conf->sendJson(json_encode($js_send));
    $this->context->smarty->assign('arrayBank',$arrayBank['banks']['bank']);
...
private function _setTestConfiguration()
{   
    Configuration::updateValue('PAYU_LATAM_MERCHANT_ID', '508029');
    Configuration::updateValue('PAYU_LATAM_ACCOUNT_ID', '512321');
    Configuration::updateValue('PAYU_LATAM_API_KEY', '4Vj8eK4rloUd272L48hsrarnUA');
    Configuration::updateValue('PAYU_LATAM_TEST', 'true');
    Configuration::updateValue('PAYU_LATAM_API_LOGIN', 'pRRXKOl8ikMmt9u');
