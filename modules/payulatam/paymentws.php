...
class PayUControllerWS extends FrontController {
    ...
    public function process() {
        ...
        $this->context->smarty->assign(array(
            'formLink' => Configuration::get('PAYU_LATAM_TEST') != 'true' ? 'https://gateway.payulatam.com/ppp-web-gateway/' : 'https://gateway.payulatam.com/ppp-web-gateway/',
    ...
    public function initParams() {
        ...
        $ref = 'Americana_' . (int) $this->context->cart->id . "_" . strtotime("now");
    ...
    public function createPendingOrder($extra_vars = array(), $metodo_de_pago, $mensaje, $order_state ) {
        try {
            ...
            $sql = "INSERT INTO "._DB_PREFIX_."sonda_payu (id_cart,date_add,pasarela)
